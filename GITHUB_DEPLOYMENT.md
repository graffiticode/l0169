...
5. Select your repository: `graffiticode/l0169`
6. Click "Connect"
...
2. Configure:
   - **Name**: `l0169-production-deploy`
   - **Description**: Deploy L0169 to production on main branch push
...
1. Click "Create Trigger"
2. Configure:
   - **Name**: `l0169-staging-deploy`
   - **Description**: Deploy L0169 staging on branch push
   - **Event**: Push to a branch
   - **Source**:
     - Repository: Your connected repo
...
```bash
PROJECT_ID=$(gcloud config get-value project)
GITHUB_REPO="graffiticode/l0169"
...
- URL: https://l0169-[hash]-uc.a.run.app
...
- URL: https://l0169-staging-[hash]-uc.a.run.app
- Full traffic routing
- Maximum instances: 10
- Memory: 256Mi

### Preview (feature branches)
- URL: https://l0169-[branch-name]-[hash]-uc.a.run.app
...
gcloud run services update-traffic l0169 \
  --to-revisions=l0169-00005-abc=100 \
  --region=us-central1
```
...
3. Verify port configuration (50169)

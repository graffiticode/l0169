...
echo "🚀 L0169 GCP Deployment Setup"
echo "=============================="
...
if [ "$DEPLOY_NOW" = "y" ]; then
    ...
    if command -v docker &> /dev/null; then
        ...
        docker build -t gcr.io/$PROJECT_ID/l0169:initial .
        docker push gcr.io/$PROJECT_ID/l0169:initial

        # Deploy to Cloud Run
        gcloud run deploy l0169 \
            --image gcr.io/$PROJECT_ID/l0169:initial \
            --platform managed \
            --region us-central1 \
            --port 50169 \
